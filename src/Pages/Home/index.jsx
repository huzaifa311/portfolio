...
const Home = () => {
    ...
    return (
        <>
            ...
            <div className={`md:flex md:justify-center ${homeClass} overflow-hidden`}>
                ...
                <div className={`md:mt-5 md:h-[100vh] h-full w-full bg-no-repeat md:bg-contain md:object-contain md:flex md:flex-row flex flex-col md:justify-center md:gap-28 gap-12 md:place-items-center md:max-w-[1500px]`}>
                    ...
                    <div>
                        <h3 className={`text-3xl font-semibold  animate__animated animate__backInDown ${textClass} `}>
                            Hi, I'm
                        </h3>
                        <h1 className={`md:text-5xl text-4xl  font-bold flex gap-2 animate__backInLeft animate__animated mt-3 ${textClass} `}>
                            <p className="text-[#FC6731]">Muhammad</p>Huzaifa
                        </h1>
                        <p className={` mt-2 md:w-[420px] animate__animated animate__backInRight ${textClass}`}>
                        ...
                        <div className="flex justify-around mt-5 animate__backInUp animate__animated">
