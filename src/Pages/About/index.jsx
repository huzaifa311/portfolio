    ...
    return (
        <>
            ...
            <div className={`md:flex flex-col md:justify-center ${homeClass} md:h-[100vh]`}>
                ...
                <div className='h-full w-full bg-no-repeat md:bg-contain md:object-contain md:flex md:flex-row flex flex-col md:justify-center md:gap-10 md:place-items-center md:max-w-[1500px] md:mt-12 md:px-[5%] px-2 pt-20'>
                    <div>
                        ...
                        <button className={`bg-[#FA6136] p-3 ${pClass} animate__animated  animate__zoomInDown text-lg rounded-xl `} onClick={redirectWhatsapp}>Contact Me</button>
                    </div>
