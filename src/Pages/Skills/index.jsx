...
const Skills = () => {
    ...
    return (
        <>
            ...
            <div className={`md:flex flex-col md:justify-center ${homeClass} max-w-[100wh] px-[5%]`}>
            <Header isDarkTheme={isDarkTheme} custom5={"text-[#FA6136]"} onClick={toggleTheme} />
                <h1 className={`mt-24 text-center tracking-wider text-6xl font-black animate__animated animate__backInRight ${textClass}`}>What I do ?</h1>
